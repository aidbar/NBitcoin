...
#pragma warning disable CS0618 // Type or member is obsolete
		...
		{
			public TechcoinBlock(TechcoinBlockHeader header) : base(header)
			{
		...
		public class TechcoinMainnetAddressStringParser : NetworkStringParser
		{
		...
		public class TechcoinTestnetAddressStringParser : NetworkStringParser
		{
			public override bool TryParse(string str, Network network, Type targetType, out IBitcoinString result)
			{
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		protected override NetworkBuilder CreateMainnet()
		{
			...
			.SetNetworkStringParser(new TechcoinMainnetAddressStringParser())
			.SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("TLC"))
			.SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("TLC"))
			.SetMagic(0xdbb6c0fb)
			.SetPort(9333)
			.SetRPCPort(9332)
			.SetName("TLC-main")
			...
			.AddDNSSeeds(new[]
			{
				new DNSSeedData("loshan.co.uk", "seed-a.Techcoin.loshan.co.uk"),
				new DNSSeedData("thrasher.io", "dnsseed.thrasher.io"),
				new DNSSeedData("Techcointools.com", "dnsseed.Techcointools.com"),
				new DNSSeedData("Techcoinpool.org", "dnsseed.Techcoinpool.org"),
		...
		protected override NetworkBuilder CreateTestnet()
		{
			...
			.SetNetworkStringParser(new TechcoinTestnetAddressStringParser())
			...
			.AddDNSSeeds(new[]
			{
				new DNSSeedData("Techcointools.com", "testnet-seed.Techcointools.com"),
				new DNSSeedData("loshan.co.uk", "seed-b.Techcoin.loshan.co.uk"),
